...
class TrainingList extends StatefulWidget {
  ...
  const TrainingList({required this.filter, super.key});
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          itemBuilder: (context, index) {
            print(cubit.trainingPostList.length);
            return widget.filter == ""
                ? buildTrainingBox(
                    context,
                    cubit.trainingPostList[index],
                  )
...
Widget buildTrainingBox(BuildContext context, PostModel model) {
  return Container(
